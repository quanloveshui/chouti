...
import io
from app1 import *
from  app1.utils.response import BaseResponse
from app1.forms.account import SendMsgForm, RegisterForm, LoginForm
from app1.utils import commons
from app1.utils import check_code as CheckCode
...
def send_msg(request):
    ...
    if form.is_valid():
        _value_dict = form.clean() #验证通过获取正确信息
        ...
        code = commons.random_code() #调用生成验证码的方法获取验证码
